...
SECRET_KEY = 'django-insecure-tq=!jd57250c#vhu2@%pjq*+&n5p0s(0r3gn=&+w+pzb%@+okf'
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': 'django_lms',  # The name of your database
        'USER': 'root',                # The default MySQL user in XAMPP
        'PASSWORD': '',                # The default password for MySQL root (often empty)
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        # Optional: If using JWT, add the following line
